...
let projects = [
    {name: 'onBelay', description: `onBelay is a partner finder app for Rock Climbers. It let's climbers connect with other potential climbing partners that climb similar styles and within the same range of grades.`, technologies: 'Front End: Javascript, React Back End: NodeJS, Express, Postgresql, PostGIS', screenshot: {desktop: 'images/screenshots/onbelay-desktop.png', mobile: 'images/screenshots/onbelay-mobile.png', alt: 'a screenshot of onBelay'}, live: 'https://onbelayapp.com/', repo: 'https://github.com/keenanmcdonald/onbelay-app', color: '#5BD393'},
    {name: 'Terra', description: 'Terra is a mapping app geared towards hikers, climbers, mountaineers. It allows users to drop waypoints and draw routes on a 3D terrain map of the world. Users can share their routes with the community and access routes left by others.', technologies: 'Front End: Javascript, React, CesiumJS library used for 3D mapping, Resium used to help integrate Cesium with React. \nBack End: NodeJS, Express.', screenshot: {desktop: 'images/screenshots/terra-desktop.png', mobile: 'images/screenshots/terra-mobile.png', alt: 'a screenshot of Terra'}, live: 'https://terra-app.keenanmcdonald.now.sh/', repo: 'https://github.com/keenanmcdonald/terra-app', color: '#74C042'},
